...
- (IBAction)logIn:(id)sender {
    CYLogInViewController *logInViewController = [[CYLogInViewController alloc] init];
    CYNavigationViewController *nav = [[CYNavigationViewController alloc]initWithRootViewController:logInViewController];
...
- (UIView *)addDivideView {
    ...
    divide.backgroundColor = [UIColor darkGrayColor];
    divide.alpha = 0.3;
    return divide;
}
