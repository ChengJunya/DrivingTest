...
- (void)jump
{
    if (self.isShowingJumpView == NO) {
        ...
        [self.navigationController.view addSubview:self.topCover];
        [self.navigationController.view addSubview:self.jumpCollectionView];
        [self.navigationController.view addSubview:self.jumpTopView];
